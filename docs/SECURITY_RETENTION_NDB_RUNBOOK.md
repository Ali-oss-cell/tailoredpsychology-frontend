# Security, Retention, and NDB Runbook (N6 + N7)

Date: 2026-05-06  
Status: Draft operational baseline (owner-assigned).
...
- Engineering source: `backend/docs/RETENTION_AND_DELETION_POLICY_AU.md`
- Before release:
...
- `frontend/docs/CORE_PLATFORM_DEEP_CHECK.md` (N6/N7 checklist)
- `frontend/docs/LEGAL_SIGNOFF_TRACKER.md` (legal ownership context)
