  ...
  return (
    <div className="space-y-6">
      <StepIntro
        ...
        description="Help your clinician prepare for your session with a few clinical details."
      />
      ...
      <div className="dashboard-card rounded-dashboard-card grid gap-4 p-5 md:grid-cols-2 md:p-6">
        ...
        <PortalFormField id="prior-care" label="Previous therapy or care">
          <PortalTextarea
            rows={3}
        ...
        <PortalFormField id="current-medications" label="Current medications">
          <PortalTextarea
            rows={3}
      ...
      <div className="space-y-4">
        <h3 className="font-heading text-base font-semibold tracking-tight">Safety for telehealth</h3>
        <div className="dashboard-card rounded-dashboard-card grid gap-4 p-5 md:grid-cols-2 md:p-6">
          <PortalFormField
            id="session-location"
