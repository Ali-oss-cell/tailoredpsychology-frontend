...
export default function AdminSettingsPage() {
  ...
  const columns: AdminDataTableColumn<AdminSettingsDomain>[] = [
    ...
    },
    {
      ...
      header: "Editable",
      sortable: true,
      sortValue: (row) => (row.editable ? 1 : 0),
      renderCell: (row) => (row.editable ? "yes" : "no"),
    },
  ]
  ...
  return (
    <OpsPortalPage
      ...
      title={opsPagesContent.adminSettings.title}
      description={opsPagesContent.adminSettings.description}
    >
      <AdminFilterBar
        searchValue={search}
