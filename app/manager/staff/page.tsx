...
export default function ManagerStaffPage() {
  ...
  return (
    <OpsShell activeRoute="manager-staff">
      <OpsPortalPage
        eyebrow="Operations"
        title={opsPagesContent.managerStaff.title}
        description={opsPagesContent.managerStaff.description}
        tutorialId="manager.page.staff"
      >
        <AdminFilterBar
          searchValue={search}
